...
DELTA = 5
RULES = [[0, 4.0, 1000, DELTA, 1], [8, 1011.8, 1000, DELTA, 1], [2, 31, 1000, DELTA, 1], [5, 0.04, 3000, DELTA, 3], 
         [2, 31, 2000, DELTA, 2], [2, 30.0, 2000, DELTA, 2], [3, 29, 2000, DELTA, 2], [8, 1011.8, 2000, DELTA, 2], 
        #  [4, 1012.90, 2000, DELTA, 2], [6, 1150, 2000, DELTA, 2], 
         [3, 32, 3000, DELTA, 3], [2, 31, 3000, DELTA, 3], [5, 0.04, 3000, DELTA, 3], [3, 29, 3000, DELTA, 3],  
        #   [6, 1150, 3000, DELTA, 3], 
         [1, 50000, 4000, DELTA, 4], [8, 1011.8, 4000, DELTA, 4], [8, 1011.8, 4000, DELTA, 4], [3, 32, 4000, DELTA, 4], 
        #  [8, 1011.8, 1000, DELTA, 1], 
         ]


RULE_FILE_NAME = ['OutdoorUV-4.txt', 'IndoorPressure_hPa-1011.8.txt', 'OutdoorTemperature_C-31.txt',
        'OutdoorTemperature_C-30.txt', 'OutdoorHumidity_pct-29.txt', 
        'OutdoorHumidity_pct-32.txt', 'OutdoorTemperature_C-31.txt', 'IndoorUV-0.04.txt',
        'OutdoorVisibleRay_Lux-50000.txt', 'IndoorPressure_hPa-1011.8.txt', 'IndoorPressure_hPa-1011.8.txt', 
        ]
